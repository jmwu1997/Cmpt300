 ...
 * it with the value ptr. Return a pointer to the new node.
 */
...
/*
 * Return the first node holding the value ptr, return NULL if none found
 */
...
/*
 * Sort the list in ascending order based on the ptr field.
